...
class Recurly_BusinessEntityTest extends Recurly_TestCase
{
  public function testGetBusinessEntity() {
    $this->client->addResponse('GET', '/business_entities/su3n18oalr9m', 'business_entities/show-200.xml');

    $business_entity = Recurly_BusinessEntity::get('su3n18oalr9m', $this->client);
